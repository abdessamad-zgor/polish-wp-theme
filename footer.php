            ...
            <section class="uk-section uk-section-secondary uk-section-small uk-light">
                <div class="uk-container">
                    <div class="uk-grid-medium uk-child-width-1-1 uk-child-width-1-4@m" uk-grid>
                        <div><a class="uk-logo" href="index.html"><imgsrc="<?php echo get_template_directory_uri() ?>/assets/imgs/logo-inverse.svg" width="90"
                                        ...
                                        <div class="uk-width-1-4">
                                            <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box"
                                                    ...
                                                    <figure class="tm-media-box-wrap"><img
                                                           src="<?php echo get_template_directory_uri() ?>/assets/imgs/products/1/1-small.jpg"
                                    ...
                                    <div class="uk-grid-small" uk-grid>
                                        <div class="uk-width-1-4">
                                            <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box"
                                                    href="product.html">
                                                    <figure class="tm-media-box-wrap"><img
                                                           src="<?php echo get_template_directory_uri() ?>/assets/imgs/products/2/2-small.jpg"
