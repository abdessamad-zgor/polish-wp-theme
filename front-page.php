...
<section class="uk-position-relative uk-visible-toggle uk-light"
                ...
                <ul class="uk-slideshow-items">
                    <li style="background-color: #0b0a12"><a href="#">
                            <figure class="uk-container uk-height-1-1"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/promo/macbook-new.jpg"
                                    alt="New Macbook" width="1200" height="600" uk-cover></figure>
                        </a></li>
                    <li style="background-color: #ce071e"><a href="#">
                            <figure class="uk-container uk-height-1-1"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/promo/iphone.jpg" alt="iPhone"
                                    width="1200" height="600" uk-cover></figure>
                        </a></li>
                    <li style="background-color: #1f2024"><a href="#">
                            <figure class="uk-container uk-height-1-1"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/promo/ipad.jpg" alt="iPad"
                                    width="1200" height="600" uk-cover></figure>
                        </a></li>
                    ...
                    <div class="uk-grid-small uk-child-width-1-2 uk-child-width-1-3@s uk-child-width-1-6@m" uk-grid>
                                ...
                                <div class="tm-ratio tm-ratio-4-3">
                                    <div class="tm-media-box">
                                        <figure class="tm-media-box-wrap"><img class="item-brand"
                                                src="<?php echo get_template_directory_uri() ?>/assets/imgs/catalog/laptops.png" alt="Laptops"></figure>
                                    </div>
                                </div>
                        ...
                        <div><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                ...
                                <div class="tm-ratio tm-ratio-4-3">
                                    <div class="tm-media-box">
                                        <figure class="tm-media-box-wrap"><img class="item-brand"
                                                src="<?php echo get_template_directory_uri() ?>/assets/imgs/catalog/smartphones.png" alt="Smartphones"></figure>
                                    </div>
                                </div>
                                <div class="uk-margin-small-top">
                        ...
                        <div><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                ...
                                <div class="tm-ratio tm-ratio-4-3">
                                    <div class="tm-media-box">
                                        <figure class="tm-media-box-wrap"><img class="item-brand"
                                                src="<?php echo get_template_directory_uri() ?>/assets/imgs/catalog/tablets.png" alt="Tablets"></figure>
                                    </div>
                                </div>
                                <div class="uk-margin-small-top">
                        ...
                        <div><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                ...
                                <div class="tm-ratio tm-ratio-4-3">
                                    <div class="tm-media-box">
                                        <figure class="tm-media-box-wrap"><img class="item-brand"
                                                src="<?php echo get_template_directory_uri() ?>/assets/imgs/catalog/watches.png" alt="Smart Watches"></figure>
                                    </div>
                                </div>
                                <div class="uk-margin-small-top">
                        ...
                        <div><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                ...
                                <div class="tm-ratio tm-ratio-4-3">
                                    <div class="tm-media-box">
                                        <figure class="tm-media-box-wrap"><img class="item-brand"
                                                src="<?php echo get_template_directory_uri() ?>/assets/imgs/catalog/consoles.png" alt="Gaming Consoles"></figure>
                                    </div>
                                </div>
                                <div class="uk-margin-small-top">
                        ...
                        <div><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                ...
                                <div class="tm-ratio tm-ratio-4-3">
                                    <div class="tm-media-box">
                                        <figure class="tm-media-box-wrap"><img class="item-brand"
                                                src="<?php echo get_template_directory_uri() ?>/assets/imgs/catalog/cameras.png" alt="Cameras"></figure>
                                    </div>
                                </div>
                                <div class="uk-margin-small-top">
                    ...
                    <div class="uk-card uk-card-default tm-ignore-container">
                        <div class="uk-grid-collapse uk-child-width-1-3 uk-child-width-1-4@m tm-products-grid" uk-grid>
                            <article class="tm-product-card">
                                <div class="tm-product-card-media">
                                    <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product.html">
                                            ...
                                            <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/products/1/1-medium.jpg"
                                ...
                                <div class="tm-product-card-media">
                                    <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product.html">
                                            <div class="tm-product-card-labels"><span
                                                    ...
                                                    class="uk-label uk-label-danger">trade-in</span></div>
                                            <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/products/2/2-medium.jpg"
                            ...
                            <article class="tm-product-card">
                                <div class="tm-product-card-media">
                                    <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product.html">
                                            <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/products/3/3-medium.jpg"
                            ...
                            <article class="tm-product-card">
                                <div class="tm-product-card-media">
                                    <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product.html">
                                            ...
                                            <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/products/4/4-medium.jpg"
                            ...
                            <article class="tm-product-card">
                                <div class="tm-product-card-media">
                                    <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product.html">
                                            <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/products/5/5-medium.jpg"
                            ...
                            <article class="tm-product-card">
                                <div class="tm-product-card-media">
                                    <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product.html">
                                            <div class="tm-product-card-labels"><span
                                                    class="uk-label uk-label-danger">trade-in</span></div>
                                            <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/products/6/6-medium.jpg"
                            ...
                            <article class="tm-product-card">
                                <div class="tm-product-card-media">
                                    <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product.html">
                                            <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/products/7/7-medium.jpg"
                            ...
                            <article class="tm-product-card">
                                <div class="tm-product-card-media">
                                    <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product.html">
                                            ...
                                            <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/products/8/8-medium.jpg"
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <div class="tm-ratio tm-ratio-16-9"><a
                                                    ...
                                                    title="Apple">
                                                    <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/brands/apple.svg"
                                                            alt="Apple"></figure>
                                                </a></div>
                                        </li>
                                        <li>
                                            <div class="tm-ratio tm-ratio-16-9"><a
                                                    ...
                                                    <figure class="tm-media-box-wrap"><img
                                                            src="<?php echo get_template_directory_uri() ?>/assets/imgs/brands/samsung.svg" alt="Samsung"></figure>
                                                </a></div>
                                        </li>
                                        <li>
                                            <div class="tm-ratio tm-ratio-16-9"><a
                                                    class="uk-link-muted tm-media-box tm-grayscale" href="#"
                                                    title="Sony">
                                                    <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/brands/sony.svg"
                                                            alt="Sony"></figure>
                                                </a></div>
                                        </li>
                                        <li>
                                            <div class="tm-ratio tm-ratio-16-9"><a
                                                    ...
                                                    title="Microsoft">
                                                    <figure class="tm-media-box-wrap"><img
                                                            src="<?php echo get_template_directory_uri() ?>/assets/imgs/brands/microsoft.svg" alt="Microsoft"></figure>
                                                </a></div>
                                        </li>
                                        <li>
                                            <div class="tm-ratio tm-ratio-16-9"><a
                                                    class="uk-link-muted tm-media-box tm-grayscale" href="#"
                                                    title="Intel">
                                                    <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/brands/intel.svg"
                                                            alt="Intel"></figure>
                                                </a></div>
                                        </li>
                                        <li>
                                            <div class="tm-ratio tm-ratio-16-9"><a
                                                    ...
                                                    <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/brands/hp.svg"
                                                            alt="HP"></figure>
                                                </a></div>
                                        </li>
                                        <li>
                                            <div class="tm-ratio tm-ratio-16-9"><a
                                                    ...
                                                    <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/brands/lg.svg"
                                                            alt="LG"></figure>
                                                </a></div>
                                        </li>
                                        <li>
                                            <div class="tm-ratio tm-ratio-16-9"><a
                                                    ...
                                                    title="Lenovo">
                                                    <figure class="tm-media-box-wrap"><img
                                                            src="<?php echo get_template_directory_uri() ?>/assets/imgs/brands/lenovo.svg" alt="Lenovo"></figure>
                                                </a></div>
                                        </li>
                                        <li>
                                            <div class="tm-ratio tm-ratio-16-9"><a
                                                    class="uk-link-muted tm-media-box tm-grayscale" href="#"
                                                    title="ASUS">
                                                    <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/brands/asus.svg"
                                                            alt="ASUS"></figure>
                                                </a></div>
                                        </li>
                                        <li>
                                            <div class="tm-ratio tm-ratio-16-9"><a
                                                    class="uk-link-muted tm-media-box tm-grayscale" href="#"
                                                    title="Acer">
                                                    <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/brands/acer.svg"
                                                            alt="Acer"></figure>
                                                </a></div>
                                        </li>
                                        <li>
                                            <div class="tm-ratio tm-ratio-16-9"><a
                                                    class="uk-link-muted tm-media-box tm-grayscale" href="#"
                                                    title="Dell">
                                                    <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/brands/dell.svg"
                                                            alt="Dell"></figure>
                                                </a></div>
                                        </li>
                                        <li>
                                            <div class="tm-ratio tm-ratio-16-9"><a
                                                    class="uk-link-muted tm-media-box tm-grayscale" href="#"
                                                    title="Canon">
                                                    <figure class="tm-media-box-wrap"><img src="<?php echo get_template_directory_uri() ?>/assets/imgs/brands/canon.svg"
                                                            alt="Canon"></figure>
                                                </a></div>
                                        </li>
                                    </ul>
                    ...
                    <div class="uk-grid-medium uk-grid-match uk-child-width-1-1 uk-child-width-1-2@s" uk-grid>
                                ...
                                <article
                                    ...
                                    <div class="tm-ratio tm-ratio-16-9">
                                        <figure class="tm-media-box uk-cover-container uk-margin-remove"><img
                                                src="<?php echo get_template_directory_uri() ?>/assets/imgs/articles/macbook-photo.jpg"
                        ...
                        <div><a href="article.html">
                                <article
                                    ...
                                    <div class="tm-ratio tm-ratio-16-9">
                                        <figure class="tm-media-box uk-cover-container uk-margin-remove"><img
                                                src="<?php echo get_template_directory_uri() ?>/assets/imgs/articles/macos.jpg" alt="Apple introduces macOS Mojave"
                                                uk-cover="uk-cover" /></figure>
                                    </div>
                                    <div class="uk-card-body">
                                        <div class="uk-article-body">
